...
Refinery::Pages.configure do |config|
  ...
  # config.friendly_id_reserved_words = ["index", "new", "session", "login", "logout", "users", "refinery", "admin", "images", "schools", "reorder", "categories", "user", "media-check", "media-rename", "playlists", "ideas", "search", "episodes", "resources", "subtitles", "registrations", "update", "saasy", "subscriptions", "show", "confirm", "password", "edit", "cancel", "confirmation", "invitation", "accept", "remove", "auth", "account", "profile", "unsubscribe", "about", "administration"]
