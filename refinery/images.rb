...
Refinery::Images.configure do |config|
  ...
  config.dragonfly_secret = "bc5ca2dad8c50f64f3910b5a5fe133a79c136f659651a6d1"
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.dragonfly_url_host = ""
  # config.datastore_root_path = "/home/kireto/robopartans/reduco/fllcasts/public/system/refinery/images"
